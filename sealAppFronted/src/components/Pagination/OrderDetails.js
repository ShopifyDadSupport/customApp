...
//  const { toggleRefresh } = useRefresh();
  function Copyportal() { // Copy the selected text to clipboard
    ...
    axios
    .post(`https://autoshipunimed.com/subscriptionPortal/order/${subscriptionPortalToken}`, {
  ...
  const handleRefreshClick = async () => {
    try {
      const response = await axios.get('https://autoshipunimed.com/subscriptionPortal/orderdetails');
